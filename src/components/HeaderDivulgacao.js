...
const HeaderDivulgacao = () => (
    <header className="flex flex-col lg:flex-row items-center mb-10">
        ...
        <div className="flex flex-col items-center sm:ml-10 sm:flex-row text-white uppercase font-bold">
            ...
            <Link href="/horarios">
                <a className="mb-4 sm:mb-0 w-full sm:w-auto mx-auto px-4 py-2 sm:p-0 rounded no-underline sm:ml-4 bg-blue-600 text-center sm:bg-transparent sm:text-left">HORÁRIOS</a>
            </Link>
